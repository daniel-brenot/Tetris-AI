...
function getScore()
	local num = tonumber(string.format("%X", memory.readbyte(0x0075)) .. string.format("%X", memory.readbyte(0x0074)) .. string.format("%X", memory.readbyte(0x0073)))
...
while true do
	...
	if controller["P1 Start"] == true then
